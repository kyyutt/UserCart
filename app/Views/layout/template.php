      ...
      <div class="footer-top">
        <div class="d-flex justify-content-between align-items-center flex-column flex-md-row text-center text-md-start">
          ...
          <ul class="d-flex flex-column flex-md-row mb-3">
            ...
            <li class="mx-2"><a href="#" class="text-light">Product</a></li>
            <li class="mx-2"><a href="#" class="text-light">Blog</a></li>
            <li class="mx-2"><a href="#" class="text-light">Contact Us</a></li>
          </ul>
        </div>
